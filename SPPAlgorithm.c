...
//    CMat_Multiply(BT, P, BTP, 4, countSat, countSat);
//    CMat_Multiply(BTP, B, N,4,countSat,4);
//    CMat_Multiply(BTP, l, W,4,countSat,1);
//    CMat_Inverse(N, 4, 4);
//    CMat_Multiply(N, W, dx, 4,4,1);

    Mat_Add(x, dx, 4, 1);
//    CMat_PrintMatrix(B, countSat, 4, "B");
//    CMat_PrintMatrix(BTP, 4, countSat, "BTP2");
//    CMat_PrintMatrix(P, countSat, countSat, "P");
//    CMat_PrintMatrix(W, 4, 1, "W");
//    CMat_PrintMatrix(l, countSat, 1, "l");
    CMat_PrintMatrix(dx, 4, 1, "dx");
